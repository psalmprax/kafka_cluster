...
- [4. Detailed SSL/TLS Configuration Guide](#detailed-ssltls-configuration-guide)  
  ...
  - [4.4 Kafka & Zookeeper Configuration](#44-kafka--zookeeper-configuration-serverproperties-zookeeperproperties)  
...
- [5. Troubleshooting Common Errors & Solutions](#troubleshooting-common-errors--solutions)  
  - [5.1 SSLHandshakeException: Empty server certificate chain](#51-javaxnetsslsslhandshakeexception-empty-server-certificate-chain)  
  - [5.2 IllegalArgumentException: No enum constant](#52-javalangillegalargumentexception-no-enum-constant-)  
  - [5.3 Could not find or load main class](#53-error-could-not-find-or-load-main-class-)  
  - [5.4 UnsupportedOperationException: SSL isn't supported](#54-javalangunsupportedoperationexception-ssl-isnt-supported-)  
  - [5.5 No cipher suites in common](#55-javaxnetsslsslhandshakeexception-no-cipher-suites-in-common)  
  ...
  - [5.9 dub path ... exists FAILED](#59-command-usrlocalbindub-path--exists-failed-)  
  - [5.10 KAFKA_SSL_KEY_CREDENTIALS is required](#510-kafka_ssl_key_credentials-is-required-)  
  - [5.11 NotSslRecordException: not an SSL/TLS record](#511-ionettyhandlersslnotsslrecordexception-not-an-ssltls-record)  
